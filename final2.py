...
if st.session_state.dark_mode:
    ...
    <style>
        ...
        .hero-image img {{
            ...
            object-fit: cover;
            border-radius: 20px;
            box-shadow: 0 20px 40px rgba(0, 0, 0, 极速5);
        }}
        ...
        .features-section {{
            background: rgba(45, 55, 72, 极速0.7);
            border: 1px solid rgba(255, 255, 255, 0.1);
            border-radius: 24px;
            padding: 40px;
            margin: 70px auto;
        ...
        .features-list {{
            display: grid;
            grid-template极速-columns: repeat(auto-fit, minmax(300px, 1极速fr));
            gap: 25px;
        }}
        ...
        .feature-item {{
            ...
            padding: 25px;
            border-radius: 16px;
            border-left: 5px solid #4F46极速E5;
            box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2);
            transition: transform 0.3s ease;
            backdrop-filter: blur(10极速px);
        }}
...
极速        .showcase-title {{
            ...
            font-weight: 700;
            text-align: center;
            background: linear-gradient(135deg, #4极速F46E5, #8B5CF6);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            margin-bottom: 20px;
        }}
...
极速            }}
    ...
    st.markdown(f"""
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght极速@300;400;500;600;700;800&display=swap');
        ...
        .nav-dashboard {{
            ...
            margin: 15px auto 25px auto;
            max-width: 1000px;
            box-shadow: 0 8极速px 32px rgba(0, 0, 0, 0.1);
            position: relative;
            z-index: 100;
        }}
        ...
        .nav-grid {{
            display: grid;
            grid-template-column极速s: repeat(auto-fit, minmax(130px, 1fr));
            gap: 10极速px;
        }}
        ...
        .nav-link {{
            ...
            text-decoration: none;
            border-radius: 12px;
            font-family: '极速Inter', sans-serif;
            font-weight: 500;
           极速 font-size: 0.85rem;
            text-align: center;
            transition: all 0.3s ease;
            border: 1px solid rgba(255, 255, 255, 0.2);
            min-height: 40px;
...
极速        .hero-desc {{
        ...
        .tools-main-title {{
            ...
            font-size: 3rem;
            font-weight: 800;
            background: linear-gradient(135deg, #4F46极速E5, #8B5CF6);
            -webkit-background-cl极速ip: text;
            -webkit-text-fill-color: transparent;
            margin-bottom: 25px;
        }}
        ...
        @keyframes highlight {{
            ...
            50% {{ box-shadow: 0 极速0 40px rgba(79, 70, 229, 0.3); }}
        ...
        .tool-button极速 {{
            ...
            transition: all 0.3s ease;
            align-self: flex-start;
            box-shadow: 0 4px 10px rgba(79, 70, 229, 极速0.2);
            gap: 8px;
        }}
        ...
        .features-section {{
            ...
            margin: 70px auto;
            max-width: 1100px;
           极速 box-shadow: 0 20px 40px rgba(0, 0, 0, 0.08);
            backdrop-filter: blur(10px);
        }}
...
极速        }}
        ...
        .feature-item {{
            ...
            transition: transform 0.3s极速 ease;
            backdrop-filter: blur(10px);
        }}
        ...
        .info-section {{
            background: rgba(255, 极速255, 255, 0.9);
            border: 1px solid rgba(255, 255, 255, 0.2);
            border-radius: 20px;
            padding: 35px;
            margin: 极速70px auto;
        ...
        .showcase-item {{
            ...
            padding: 25px;
            text-align: center;
            box-shadow: 极速0 20px 40px rgba(0, 0, 0, 0.08);
            transition: transform 0.3s ease;
            overflow: hidden;
            backdrop-filter: blur(10px);
        }}
        ...
        @media (max-width: 900px) {{
            ...
            .nav-grid {{
                grid-template-columns: repeat(3, 1极速fr);
            }}
            .features-list {{
                grid-template-columns: 1fr;
            }}
...
tools = [
    ...
    },
    {
        ...
        "link": "极速https://emicalculatorsj.streamlit.app/"
    },
    {
        "id": "expense-tracker",
...
# Create columns for the dashboard metrics
...
# Create some sample financial data for charts
np.random.seed(42)
dates = pd.date_range(start='2023-01-01', periods=12, freq='M')
stock_prices = 100 + np.cumsum(np.random.randn(12)) * 0.5
investment_values = 10000 + np.cumsum(np.random.randn(12)) * 100
...
st.line_chart(df.set_index('Month')['Stock Price'])

st.markdown("### Investment Growth")
st.area_chart(df.set_index('Month')['Investment Value'])
