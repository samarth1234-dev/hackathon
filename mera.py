...
if st.session_state.dark_mode:
    # Professional Dark theme CSS with compact navigation dashboard
    st.markdown(f"""
    <style>
        ...
        /* Compact Navigation Dashboard Styling */
        .nav-dashboard {{
    ...
    # Professional Light theme CSS with compact navigation dashboard
    st.markdown(f"""
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap');
