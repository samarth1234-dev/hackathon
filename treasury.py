...
if section == "🏠 Overview":
    ...
    with col2:
        ...
        fig = px.line(x=years_list, y=values, 
                     labels={'x': 'Years', 'y': 'Investment Value'},
    ...
    # Simulated market data (in real app, you'd use API)
    treasury_data = {
    ...
    fig = px.line(x=dates, y=historical_yields, 
                 labels={'x': 'Date', 'y': 'Yield (%)'},
                 title='10-Year Treasury Yield (Last 12 Months)')
    st.plotly_chart(fig, use_container_width=True)
